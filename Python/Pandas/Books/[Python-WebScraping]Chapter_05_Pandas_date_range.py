...
pd.date_range(start='2020-07-01', end='2020-07-10', freq='2D')  # D = 하루주기
...
# 30min : 30T / freq = 10T 10분 주기, freq = 30S 30초주기
'''
...
'''
# freq는 여러개로 지정할 수 없으면 만약 30분 30초주기로 설정하고 싶다면 1830S 활용
