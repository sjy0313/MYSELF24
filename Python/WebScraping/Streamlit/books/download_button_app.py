...
csv_data = df.to_csv()
'''
csv_data = pd.read_csv("D:\WORKSPACE\Python\WebScraping\Streamlit\books", encoding = "utf-8")
'''
...
st.download_button("CSV 파일 다운로드", csv_data, file_name='KTX_users.csv',encoding = "utf-8")
