...
# 짝수 이며 조건을 만족하는 요소  # array([6, 8])
a[ ((a % 2)==0) & (a > 5) ] # 두 조건을 동시에 만족하는 요소만 선택


# In[ ]:

# array([0, 2, 4, 6, 7, 8, 9]) 짝수와 a>5인 9 
a[ ((a % 2)==0) | (a > 5) ] # 두 조건 중 하나만 만족해도 요소 선택


# In[ ]:

# 논리부정 짝수가 아닌것인 홀수 # array([1, 3, 5, 7, 9]) 
