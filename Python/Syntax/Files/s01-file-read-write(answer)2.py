...
#%%
# sys 모듈을 사용해서 프로그램에 인수를 전달
import sys
import  StudentScore as sc1
...
print("프로그램 인수:", args)
if len(args) != 3:
    print("\t프로그램 인수의 갯수가 맞지 않습니다")
    print(f"\tusage: {args[0]}, 처리대상파일 처리결과 파일")
    print(f" \t기본 파일로 처리하겠습니다")
else:
    
    rfile = args[1]
    wfile = args[2]

print("성적 처리대상 파일:", rfile)
print("성적 처리결과 파일:", wfile)
